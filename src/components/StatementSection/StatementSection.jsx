...
const WORDS = [
  { text: 'Crafted', type: 'word' },
  { text: 'with', type: 'word' },
  { text: 'precision', type: 'word' },
  { text: '—', type: 'pill-wrap' },
  { text: 'stunning', type: 'word' },
  { text: '3D', type: 'word' },
  { text: 'liquid', type: 'word' },
  { text: 'animations', type: 'word' },
  { type: 'pill-silver' },
  { text: 'powered', type: 'word' },
  { text: 'by', type: 'word' },
  { text: 'Three.js,', type: 'word' },
  { text: 'GSAP,', type: 'word' },
  { text: 'and', type: 'word' },
  { text: 'modern', type: 'word' },
  { type: 'pill-glow' },
  { text: 'web', type: 'word' },
  { text: 'technologies', type: 'word' },
  { type: 'avatars' },
  { text: 'designed', type: 'word' },
  { text: 'to', type: 'word' },
  { text: 'deliver', type: 'word' },
  { text: 'premium', type: 'word' },
  { text: 'digital', type: 'word' },
  { text: 'experiences.', type: 'word' },
]
